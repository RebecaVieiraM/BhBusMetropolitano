package com.example.bhbusmetropolitano.repository
...
import com.example.bhbusmetropolitano.repository.dao.OnibusDao

@Database(entities = [OnibusModel::class], version = 1)
